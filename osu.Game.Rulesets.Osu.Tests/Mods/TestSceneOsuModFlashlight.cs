...
namespace osu.Game.Rulesets.Osu.Tests.Mods
{
    public partial class TestSceneOsuModFlashlight : OsuModTestScene
    {
        ...
        [Test]
        public void TestSliderStopsDimmingAfterEndTime()
        {
            bool sliderDimmedAfterEndTime = false;
            ...
            CreateModTest(new ModTestData
            {
                ...
                PassCondition = () =>
                {
                    sliderDimmedAfterEndTime |=
                        Player.GameplayClockContainer.CurrentTime >= 3000 && Player.ChildrenOfType<ModFlashlight<OsuHitObject>.Flashlight>().Single().FlashlightDim > 0;
                    return Player.GameplayState.HasPassed && !sliderDimmedAfterEndTime;
                },
                CreateBeatmap = () => new OsuBeatmap
                {
                    HitObjects = new List<OsuHitObject>
                ...
                ReplayFrames = new List<ReplayFrame>
                {
                    new OsuReplayFrame(990, new Vector2(), OsuAction.LeftButton),
                    new OsuReplayFrame(2000, new Vector2(100), OsuAction.LeftButton),
                    new OsuReplayFrame(5500, new Vector2(100), OsuAction.LeftButton),
                    new OsuReplayFrame(5501, new Vector2(100)),
                },
                Autoplay = false,
            });
        }
