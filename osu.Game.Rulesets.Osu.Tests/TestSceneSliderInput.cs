...
namespace osu.Game.Rulesets.Osu.Tests
{
    public partial class TestSceneSliderInput : RateAdjustedBeatmapTestScene
    {
        ...
        [Test]
        public void TestVeryShortSliderMissHeadCompletesWithSkinPerformanceMode()
        {
            AddStep("enable skin performance mode", () => SkinPerformanceMode.Enabled = true);

            performTest(new List<ReplayFrame>
            {
                new OsuReplayFrame { Position = new Vector2(100, 0), Time = time_slider_start - 10 },
                new OsuReplayFrame { Position = new Vector2(100, 0), Time = time_slider_start + 2000 },
            }, new Slider
            {
            ...
            AddAssert("head judgement recorded", () => judgementResults.Any(r => r.HitObject is SliderHeadCircle));
            AddAssert("tail judgement recorded", () => judgementResults.Any(r => r.HitObject is SliderTailCircle));
            AddAssert("slider judgement recorded", () => judgementResults.Any(r => r.HitObject is Slider));
        }
