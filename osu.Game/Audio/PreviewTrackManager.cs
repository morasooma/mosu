...
namespace osu.Game.Audio
{
    public partial class PreviewTrackManager : Component
    {
        ...
        public partial class TrackManagerPreviewTrack : PreviewTrack
        {
            ...
            protected override Track GetTrack() => trackManager.Get(GetPreviewUrl(beatmapSetInfo));

            internal static string GetPreviewUrl(IBeatmapSetInfo beatmapSetInfo) =>
                beatmapSetInfo is APIBeatmapSet { Preview.Length: > 0 } onlineSet
                    ? onlineSet.Preview
