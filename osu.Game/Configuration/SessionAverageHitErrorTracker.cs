...
namespace osu.Game.Configuration
{
    ...
    public partial class SessionAverageHitErrorTracker : Component
    {
        ...
        private void calculateAverageHitError(ScoreInfo? newScore)
        {
            ...
            // Dodge hit events describe collisions/grazes rather than rhythmic input.
            // Including them would make the global audio offset recommendation react to Dodge gameplay.
            if (newScore.Ruleset.ShortName == RulesetInfo.DODGE_MODE_SHORTNAME)
                return;
