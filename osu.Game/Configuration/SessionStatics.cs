...
namespace osu.Game.Configuration
{
    ...
    public class SessionStatics : InMemoryConfigManager<Static>
    {
        protected override void InitialiseDefaults()
        {
            ...
            SetDefault<Score?>(Static.LoadedReplayBotScore, null);
    ...
    public enum Static
    {
        ...
        /// <summary>
        /// Stores a replay selected from the replay screen for replay-bot playback in the next compatible gameplay session.
        /// </summary>
        LoadedReplayBotScore,
