...
namespace osu.Game.Graphics.UserInterfaceV2
{
    public partial class FormControlBackground : CompositeDrawable
    {
        ...
        protected override void LoadComplete()
        {
            ...
            themeColour.BindValueChanged(_ => updateStyle());
        ...
        private void updateStyle()
        {
            ...
            double duration = OverlayColourProvider.ThemeTransitionDuration(250);
            this.TransformTo(nameof(BorderColour), border ? borderColour : colour, duration, Easing.OutQuint);

            box.FadeColour(colour, duration, Easing.OutQuint);
        }
    }
