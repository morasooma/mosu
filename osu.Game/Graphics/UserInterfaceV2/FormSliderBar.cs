        ...
        where T : struct, INumber<T>, IMinMaxValue<T>
    {
        ...
        public partial class InnerSlider : OsuSliderBar<T>
        {
            ...
            private void updateState()
            {
                ...
                leftBox.FadeColour(leftColour, duration, Easing.OutQuint);
                nub.FadeColour(nubColour, duration, Easing.OutQuint);
                defaultLine.FadeColour(defaultLineColour, duration, Easing.OutQuint);
            }
