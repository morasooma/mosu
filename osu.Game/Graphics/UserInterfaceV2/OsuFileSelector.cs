...
namespace osu.Game.Graphics.UserInterfaceV2
{
    public partial class OsuFileSelector : FileSelector
    {
        ...
        private Box selectorBackground = null!;
        ...
        private void load(OverlayColourProvider colourProvider)
        {
            ...
            AddInternal(selectorBackground = new Box
            {
            ...
            {
                selectorBackground.Colour = this.colourProvider.Background5;
                hiddenToggleBackground.Colour = this.colourProvider.Background4;
            }, true);
        }
        ...
        protected partial class OsuDirectoryListingFile : DirectoryListingFile
        {
            ...
            private void load(OverlayColourProvider colourProvider)
            {
                ...
                themeColour.BindValueChanged(_ => Colour = this.colourProvider.Light3, true);
            }
