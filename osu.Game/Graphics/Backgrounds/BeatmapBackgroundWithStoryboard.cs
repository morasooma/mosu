...
namespace osu.Game.Graphics.Backgrounds
{
    public partial class BeatmapBackgroundWithStoryboard : BeatmapBackground
    {
        ...
        public bool KeepBackgroundVisibleWhenStoryboardReplaces { get; init; }
        ...
        public void LoadStoryboard(bool async = true)
        {
            ...
            {
                Logger.Error(e, $"Storyboard background failed to load for {Beatmap}");
                drawableStoryboard = null;
                updateStoryboardVisibility();
            }
        ...
        private void updateStoryboardVisibility()
        {
            ...
            bool showBackground = KeepBackgroundVisibleWhenStoryboardReplaces || !showStoryboard || !Beatmap.Storyboard.ReplacesBackground;
