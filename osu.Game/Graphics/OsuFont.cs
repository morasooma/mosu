...
namespace osu.Game.Graphics
{
    public static class OsuFont
    {
        ...
        /// <summary>
        /// Retrieves a <see cref="FontUsage"/> using a custom font family name.
        /// </summary>
        /// <param name="family">The font family name.</param>
        /// <param name="size">The size of the text in local space.</param>
        /// <param name="weight">The font weight.</param>
        /// <param name="italics">Whether the font is italic.</param>
        /// <param name="fixedWidth">Whether all characters should be spaced the same distance apart.</param>
        /// <returns>The <see cref="FontUsage"/>.</returns>
        public static FontUsage GetFont(string family, float size = DEFAULT_FONT_SIZE, FontWeight weight = FontWeight.Medium, bool italics = false, bool fixedWidth = false)
        {
            if (string.IsNullOrWhiteSpace(family))
                return GetFont(Typeface.Torus, size, weight, italics, fixedWidth);

            return new FontUsage(family, size, GetWeightString(family, weight), getItalics(italics), fixedWidth);
        }
