...
namespace osu.Game.Graphics.UserInterface
{
    public partial class OsuCheckbox : Checkbox
    {
        ...
        public MarginPadding LabelPadding
        {
            ...
            set => LabelTextFlowContainer?.Padding = value;
        }
        ...
        private void load(AudioManager audio, OverlayColourProvider colourProvider)
        {
            ...
            if (colourProvider != null)
            {
                ...
                themeColour.BindValueChanged(colour => LabelTextFlowContainer.Colour = colour.NewValue, true);
            }
            else
            {
                themeMode = OverlayColourProvider.CurrentTheme.GetBoundCopy();
                themeMode.BindValueChanged(_ => LabelTextFlowContainer.Colour = OverlayColourProvider.IsLightTheme ? Color4.Black : Color4.White, true);
            }
        }
