        ...
        private void load()
        {
            InternalChild = new FillFlowContainer
            {
                ...
                Children = new Drawable[]
                {
                    ...
                    {
                        cp.Font = OsuFont.Default.With(size: 16, weight: FontWeight.SemiBold);
                        cp.Colour = OverlayColourProvider.IsLightTheme ? colourProvider.Content1 : Colour4.White;
                    })
                    {
                        Text = text,
                        RelativeSizeAxes = Axes.X,
            ...
            themeColour.BindValueChanged(_ => textFlow.Colour = OverlayColourProvider.IsLightTheme ? colourProvider.Content1 : Colour4.White, true);
        }
