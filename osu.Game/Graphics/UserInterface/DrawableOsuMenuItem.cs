    ...
    public partial class DrawableOsuMenuItem : Menu.DrawableMenuItem
    {
        ...
        private void load()
        {
            ...
            if (OverlayColourProvider.IsDarkTheme)
                BackgroundColourHover = Color4Extensions.FromHex(@"333333");
            else if (OverlayColourProvider.IsLightTheme)
                BackgroundColourHover = Color4Extensions.FromHex(@"dde0e4");
            else
            ...
            if (showChevron)
            {
                AddInternal(chevron = new SpriteIcon
                {
        ...
        private void updateThemeColours()
        {
            ...
            updateText();
            if (chevron != null)
                chevron.Colour = OverlayColourProvider.IsLightTheme ? Color4.Black : Color4.White;
        }
        ...
        private void updateText()
        {
            ...
            switch (osuMenuItem?.Type)
            {
                ...
                case MenuItemType.Standard:
                    text.Colour = OverlayColourProvider.IsLightTheme
