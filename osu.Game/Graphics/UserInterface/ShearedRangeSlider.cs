...
namespace osu.Game.Graphics.UserInterface
{
    public partial class ShearedRangeSlider : CompositeDrawable
    {
        ...
        private Box labelBackgroundBox = null!;
        ...
        {
            labelBackgroundBox.Colour = OverlayColourProvider.IsLightTheme ? colourProvider.Background2 : colourProvider.Background3;
