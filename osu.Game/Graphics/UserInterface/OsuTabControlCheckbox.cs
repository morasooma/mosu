    ...
    public partial class OsuTabControlCheckbox : Checkbox
    {
        ...
        private void load(OsuColour colours, AudioManager audio)
        {
            if (colourProvider != null)
            {
                ...
                themeColour.BindValueChanged(_ => updateFade(), true);
            }
            else if (accentColour == null)
        ...
        {
            double duration = OverlayColourProvider.ThemeTransitionDuration(transition_length);
            box.FadeTo(Current.Value || IsHovered ? 1 : 0, duration, Easing.OutQuint);
            text.FadeColour(Current.Value || IsHovered
                ? (OverlayColourProvider.IsLightTheme && colourProvider != null ? colourProvider.Content1 : Color4.White)
                : AccentColour, duration, Easing.OutQuint);
        }
    }
}
