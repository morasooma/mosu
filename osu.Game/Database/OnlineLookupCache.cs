...
namespace osu.Game.Database
{
        ...
        where TRequest : APIRequest
    {
        ...
        protected virtual IAPIProvider GetAPIProvider(IAPIProvider defaultProvider) => defaultProvider;
        ...
        private async Task performLookup()
        {
            ...
            await GetAPIProvider(api).PerformAsync(request).ConfigureAwait(false);
