...
namespace osu.Game.Tests.Visual.Multiplayer
{
    ...
    public partial class TestMultiplayerClient : MultiplayerClient
    {
        ...
        {
            RankedPlayRoomState state = (RankedPlayRoomState)ServerRoom!.MatchState!;
            state.Users[api.LocalUser.Value.OnlineID].Life = 0;
            state.Stage = RankedPlayStage.Ended;
            return ChangeMatchRoomState(state);
        }
