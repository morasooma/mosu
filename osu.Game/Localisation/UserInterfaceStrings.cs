...
namespace osu.Game.Localisation
{
    public static class UserInterfaceStrings
    {
        ...
        /// "default music theme"
        /// </summary>
        public static LocalisableString OsuMusicTheme => new TranslatableString(getKey(@"osu_music_theme"), @"default music theme");
        ...
        /// <summary>
        /// "Changes to this setting will only apply with an active Morasooma Supporter tag."
        /// </summary>
        public static LocalisableString NotSupporterNote => new TranslatableString(getKey(@"not_supporter_note"), @"Changes to this setting will only apply with an active Morasooma Supporter tag.");
