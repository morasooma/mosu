...
namespace osu.Game.Localisation
{
    public static class SongSelectStrings
    {
        ...
        /// <summary>
        /// "There are no Dodge beatmaps in your library yet."
        /// </summary>
        public static LocalisableString NoDodgeBeatmapsDescription => new TranslatableString(getKey(@"no_dodge_beatmaps_description"), @"There are no Dodge beatmaps in your library yet.");

        /// <summary>
        /// "Browse Dodge beatmaps"
        /// </summary>
        public static LocalisableString BrowseDodgeBeatmaps => new TranslatableString(getKey(@"browse_dodge_beatmaps"), @"Browse Dodge beatmaps");
