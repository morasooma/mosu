...
namespace osu.Game.Rulesets.Scoring
{
    public partial class ScoreProcessor : JudgementProcessor
    {
        ...
        /// <summary>
        /// When <see langword="true"/>, all mod score multipliers will be forced to 1.00x.
        /// Set this to <see langword="true"/> when the score is played in Ranked Play mode.
        /// </summary>
        public readonly BindableBool IsRankedPlay = new BindableBool();
        ...
        private void updateScoreMultiplier()
        {
            ...
            var calculator = Ruleset.CreateScoreMultiplierCalculator(new ScoreMultiplierContext(Beatmap.Value.BeatmapInfo.Difficulty, isRankedPlay: IsRankedPlay.Value));
