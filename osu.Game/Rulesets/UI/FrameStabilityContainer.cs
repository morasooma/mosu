...
namespace osu.Game.Rulesets.UI
{
    ...
    public sealed partial class FrameStabilityContainer : Container, IHasReplayHandler, IFrameStableClock
    {
        ...
        private void updateClock()
        {
            ...
            {
                bool treatNegativeRateAsRewinding = (parentGameplayClock as GameplayClockContainer)?.TreatNegativeRateAsRewinding ?? true;
                IsRewinding = framedClock.ElapsedFrameTime < 0 && treatNegativeRateAsRewinding;
            }
        }
