...
namespace osu.Game.Rulesets.UI
{
    public partial class GameplayCursorContainer : CursorContainer
    {
        ...
        /// <summary>
        /// Allows render-only paths to bind cursor effects to a deterministic external clock.
        /// </summary>
        public virtual void PrepareForDeterministicRender(IFrameBasedClock gameplayClock)
        {
        }
    }
}
