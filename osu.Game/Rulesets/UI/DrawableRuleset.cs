...
namespace osu.Game.Rulesets.UI
{
    ...
    public abstract partial class DrawableRuleset : CompositeDrawable
    {
        ...
        /// <summary>
        /// Whether the compose editor should generate and update an autoplay replay for this drawable ruleset.
        /// </summary>
        /// <remarks>
        /// Rulesets which do not display an autoplay-controlled player in the compose editor can disable this
        /// to avoid unnecessary replay generation after every committed edit.
        /// </remarks>
        public virtual bool RequiresEditorReplay => true;
        ...
        /// <summary>
        /// Returns the first available <see cref="HitWindows"/> modified for visual display, if applicable.
