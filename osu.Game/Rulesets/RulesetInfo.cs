...
namespace osu.Game.Rulesets
{
    ...
    public class RulesetInfo : RealmObject, IEquatable<RulesetInfo>, IComparable<RulesetInfo>, IRulesetInfo
    {
        ...
        public const string DODGE_MODE_SHORTNAME = "dodge";
        ...
        public Ruleset CreateInstance()
        {
            ...
            // Preserve special online IDs such as relax/autopilot on the created ruleset instance.
            // Clone is used to avoid passing around a realm-attached object.
