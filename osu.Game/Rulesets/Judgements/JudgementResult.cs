...
namespace osu.Game.Rulesets.Judgements
{
    ...
    public class JudgementResult
    {
        ...
        /// <summary>
        /// The visual representation of the hit result, which may differ from the logical <see cref="Type"/>.
        /// Used by hit error meters and judgement displays when visual modifications are applied.
        /// </summary>
