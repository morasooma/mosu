...
namespace osu.Game.Rulesets.Judgements
{
    ...
    public partial class DrawableJudgement : PoolableDrawable
    {
        ...
        private Container? aboveHitObjectsContent;
        private Drawable? aboveHitObjectsProxy;

        public Drawable? ProxiedAboveHitObjectsContent { get; private set; }
        ...
        private void runAnimation()
        {
            ...
            using (BeginAbsoluteSequence(Result.TimeAbsolute))
            {
                ...
                var animType = Result.VisualType ?? Result.Type;
                switch (animType)
                {
                    case HitResult.None:
                        break;
        ...
        {
            var type = Result?.VisualType ?? Result?.Type ?? HitResult.Perfect; //TODO: better default type from ruleset
            ...
            void proxyContent()
            {
                ...
                ProxiedAboveHitObjectsContent = null;
                ...
                if (JudgementBody.Drawable is IAnimatableJudgement animatable)
                {
                    ...
                    {
                        ensureAboveHitObjectsContent().Add(proxiedContent);
                        ProxiedAboveHitObjectsContent = aboveHitObjectsProxy;
                    }
                }
            }
        }
        ...
        private Container ensureAboveHitObjectsContent()
        {
            if (aboveHitObjectsContent != null)
                return aboveHitObjectsContent;
            ...
            aboveHitObjectsProxy = aboveHitObjectsContent.CreateProxy();
            return aboveHitObjectsContent;
        }
    }
}
