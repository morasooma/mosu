...
namespace osu.Game.Utils
{
    ...
    public class SentryLogger : IDisposable
    {
        ...
        public SentryLogger(OsuGame game, Storage? storage = null, bool forceDisable = false)
        {
            this.game = game;

            if (forceDisable || Environment.GetEnvironmentVariable("OSU_DISABLE_ERROR_REPORTING") == "1")
                return;
