...
namespace osu.Game.Skinning
{
    public partial class LegacyHealthDisplay : HealthDisplay, ISerialisableDrawable
    {
        ...
        private void load(OsuConfigManager config, ISkinSource source)
        {
        ...
        protected override void Update()
        {
            ...
            fill.Width = SkinPerformanceMode.ShouldSimplifyHud
        ...
        {
            if (increase && !SkinPerformanceMode.ShouldSimplifyHud)
                marker.Bulge();
        ...
        protected override void Flash()
        {
            if (!SkinPerformanceMode.ShouldSimplifyHud)
                marker.Flash(Current.Value >= epic_cutoff);
        }
