...
namespace osu.Game.Skinning
{
    public partial class LegacyKeyCounter : KeyCounter
    {
        ...
        protected override void Activate(bool forwardPlayback = true)
        {
            ...
            keyContainer.ScaleTo(0.75f, SkinPerformanceMode.ShouldFreezeAnimations ? 0 : transition_duration, Easing.Out);
            ...
            {
                activatedOnce = true;
                initialNameText.FadeOut(SkinPerformanceMode.ShouldFreezeAnimations ? 0 : transition_duration, Easing.Out);
                overlayKeyText.FadeIn(SkinPerformanceMode.ShouldFreezeAnimations ? 0 : transition_duration, Easing.Out);
            }
        }
        ...
        protected override void Deactivate(bool forwardPlayback = true)
        {
            ...
            keyContainer.ScaleTo(1f, SkinPerformanceMode.ShouldFreezeAnimations ? 0 : transition_duration, Easing.Out);
            keySprite.Colour = Colour4.White;

            if (!forwardPlayback && activatedOnce && CountPresses.Value == 0)
            {
                activatedOnce = false;
                initialNameText.FadeIn(SkinPerformanceMode.ShouldFreezeAnimations ? 0 : transition_duration, Easing.Out);
                overlayKeyText.FadeOut(SkinPerformanceMode.ShouldFreezeAnimations ? 0 : transition_duration, Easing.Out);
            }
        }
    }
}
