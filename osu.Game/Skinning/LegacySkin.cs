...
namespace osu.Game.Skinning
{
    public class LegacySkin : Skin
    {
        ...
        public override Texture? GetTexture(string componentName, WrapMode wrapModeS, WrapMode wrapModeT)
        {
            ...
            float ratio = 1;
            bool preferLowResolution = SkinPerformanceMode.PreferLowResolutionLegacyTexture(componentName);
            string? twoTimesFilename = null;
            ...
            if (AllowHighResolutionSprites)
            {
                ...
                twoTimesFilename = $"{Path.ChangeExtension(componentName, null)}@2x{Path.GetExtension(componentName)}";
            ...
            if (texture == null && twoTimesFilename != null)
            {
                texture = Textures?.Get(twoTimesFilename, wrapModeS, wrapModeT);
            ...
            if (texture != null)
            {
                ratio *= SkinPerformanceMode.LegacyTextureScaleAdjust(componentName);
