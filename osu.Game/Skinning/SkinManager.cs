...
namespace osu.Game.Skinning
{
    ...
    public class SkinManager : ModelManager<SkinInfo>, ISkinSource, IStorageResourceProvider, IModelImporter<SkinInfo>
    {
        ...
        /// <summary>
        /// Recreates the current skin and notifies all skinnable drawables of the new source.
        /// This is required when a setting changes how legacy textures are loaded, as those textures are cached by the skin instance.
        /// </summary>
        public void ReloadCurrentSkin() => CurrentSkin.Value = CurrentSkinInfo.Value.PerformRead(GetSkin);
