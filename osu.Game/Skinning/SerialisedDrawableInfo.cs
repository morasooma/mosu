...
namespace osu.Game.Skinning
{
    ...
    {
        [JsonConverter(typeof(SerialisedDrawableTypeConverter))]
        ...
        public SerialisedDrawableInfo(Drawable component)
        {
            ...
            foreach (var (attr, property) in component.GetSettingsSourceProperties())
            {
                if (attr.ExcludeFromSerialisation)
                    continue;
