...
namespace osu.Game.Online.Leaderboards
{
    public partial class LeaderboardScore : OsuClickableContainer, IHasContextMenu, IHasCustomTooltip<ScoreInfo>
    {
        ...
        private float idleBackgroundAlpha => OverlayColourProvider.IsLightTheme ? background_alpha * 2.2f : background_alpha;
        private float hoverBackgroundAlpha => OverlayColourProvider.IsLightTheme ? 0.7f : 0.5f;
        ...
        private void load(IAPIProvider api, OsuColour colour)
        {
            ...
            if (colourProvider != null)
            {
                ...
                themeColour.BindValueChanged(_ => background.FadeTo(IsHovered ? hoverBackgroundAlpha : idleBackgroundAlpha, OverlayColourProvider.ThemeTransitionDuration(150), Easing.OutQuint), true);
            }
        ...
        {
            background.FadeTo(hoverBackgroundAlpha, 300, Easing.OutQuint);
            return base.OnHover(e);
        }

        protected override void OnHoverLost(HoverLostEvent e)
        {
            background.FadeTo(idleBackgroundAlpha, 200, Easing.OutQuint);
            base.OnHoverLost(e);
        }
