...
namespace osu.Game.Online.API
{
    public partial class LocalUserState : Component, ILocalUserState
    {
        ...
        public void SetStableLocalUser(int userId, string username, string banchoUrl)
        {
            if (localUser.Value.Id == userId && localUser.Value.Username == username)
                return;
            ...
            localUser.Value = new APIUser
            {
                Id = userId,
                Username = username,
                AvatarUrl = $"{banchoUrl.TrimEnd('/').Replace("//c.", "//a.")}/{userId}",
            };
        }
