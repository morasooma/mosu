...
namespace osu.Game.Online
{
    ...
    public interface IStatefulUserHubClient
    {
        ...
        /// <summary>
        /// Invoked when the server wants to display a global system notification to the user.
        /// </summary>
        /// <param name="notificationId">A server-generated identifier used to deduplicate deliveries across hubs.</param>
        /// <param name="message">The message to display.</param>
        Task SystemNotification(string notificationId, string message);
    }
}
