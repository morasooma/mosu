...
namespace osu.Game.Beatmaps
{
    ...
    public partial class FramedBeatmapClock : Component, IFrameBasedClock, IAdjustableClock, ISourceChangeableClock
    {
        ...
        /// <summary>
        /// The user-facing offset applied to beatmap time, excluding platform compensation.
        /// Platform offsets only exist to correct live BASS output latency and should not be applied
        /// when muxing audio directly from beatmap files.
        /// </summary>
        public double UserAppliedOffset
        {
            get
            {
                if (!applyOffsets)
