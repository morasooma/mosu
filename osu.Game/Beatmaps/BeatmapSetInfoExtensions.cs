...
namespace osu.Game.Beatmaps
{
    ...
    {
        public const string ServerExclusiveTag = "mosu-exclusive";
        ...
        public static bool IsServerExclusive(this IBeatmapSetInfo? beatmapSetInfo) => beatmapSetInfo?.Metadata.IsServerExclusive() == true;

        public static bool IsServerExclusive(this IBeatmapMetadataInfo? metadata)
        {
            ...
            return metadata.Tags
                           ...
                           .Any(tag => string.Equals(tag, ServerExclusiveTag, StringComparison.OrdinalIgnoreCase));
        }
    }
}
