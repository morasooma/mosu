...
namespace osu.Game.Beatmaps.Drawables
{
    ...
    public partial class BundledBeatmapDownloader : CompositeDrawable
    {
        ...
        protected override IReadOnlyDependencyContainer CreateChildDependencies(IReadOnlyDependencyContainer parent)
        {
            ...
            var config = parent.Get<osu.Game.Configuration.OsuConfigManager>();
            localDependencies.CacheAs<BeatmapModelDownloader>(beatmapDownloader = new BundledBeatmapModelDownloader(parent.Get<BeatmapManager>(), parent.Get<IAPIProvider>(), config));
        ...
        {
            public BundledBeatmapModelDownloader(IModelImporter<BeatmapSetInfo> beatmapImporter, IAPIProvider api, osu.Game.Configuration.OsuConfigManager config = null)
                : base(beatmapImporter, api, config)
            {
            }
            ...
            public class BundledBeatmapDownloadRequest : DownloadBeatmapSetRequest
            {
                ...
                {
                    // The bundled asset URL is the last-resort server source, after the regular
                    // map mirrors have been tried.
