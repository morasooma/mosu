...
namespace osu.Game.Beatmaps
{
    ...
    {
        /// <summary>
        /// Retrieves the online status from the known local and API beatmap representations.
        /// Unknown implementations intentionally fall back to <see cref="BeatmapOnlineStatus.None"/>.
        /// </summary>
        public static BeatmapOnlineStatus GetOnlineStatus(this IBeatmapInfo beatmapInfo) => beatmapInfo switch
        {
            BeatmapInfo local => local.Status,
            APIBeatmap online => online.Status,
