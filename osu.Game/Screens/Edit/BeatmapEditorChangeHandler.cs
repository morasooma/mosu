...
namespace osu.Game.Screens.Edit
{
    public partial class BeatmapEditorChangeHandler : EditorChangeHandler
    {
        ...
        private readonly ICustomEditorBeatmapStateHandler? customStateHandler;
        ...
        public BeatmapEditorChangeHandler(EditorBeatmap editorBeatmap)
        {
            ...
            customStateHandler = editorBeatmap.BeatmapInfo.Ruleset.CreateInstance() as ICustomEditorBeatmapStateHandler;
        }

        protected override void WriteCurrentStateToStream(MemoryStream stream)
        {
            if (customStateHandler != null)
            {
                customStateHandler.WriteEditorState(editorBeatmap, stream);
                return;
            }
        ...
        {
            if (customStateHandler != null)
                customStateHandler.ApplyEditorState(editorBeatmap, previousState, newState);
            else
