...
namespace osu.Game.Screens.Menu
{
    ...
    public partial class MainMenuButton : BeatSyncedContainer, IStateful<ButtonState>
    {
        ...
        protected override void LoadComplete()
        {
            ...
            disableShear.BindValueChanged(e => updateShear(e.NewValue), true);
        ...
        private void updateShear(bool disabled)
        {
            background.Shear = disabled ? Vector2.Zero : new Vector2(ButtonSystem.WEDGE_WIDTH / initialSize.Y, 0);
