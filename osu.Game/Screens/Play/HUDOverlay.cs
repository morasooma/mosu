...
namespace osu.Game.Screens.Play
{
    ...
    public partial class HUDOverlay : Container, IKeyBindingHandler<GlobalAction>
    {
        ...
        /// <summary>
        /// Recreates all skin-provided HUD layers without leaving the current play session.
        /// </summary>
        public void ReloadSkinComponents()
        {
        ...
        protected override void LoadComplete()
        {
            ...
            SkinPerformanceMode.SettingsChanged += ReloadSkinComponents;
