    ...
    public partial class JudgementCounter : VisibilityContainer
    {
        ...
        protected override void LoadComplete()
        {
            ShowName.BindValueChanged(value =>
                ResultName.FadeTo(value.NewValue ? 1 : 0, SkinPerformanceMode.ShouldSimplifyHud ? 0 : JudgementCounterDisplay.TRANSFORM_DURATION, Easing.OutQuint), true);
        ...
        protected override void PopIn() => this.FadeIn(SkinPerformanceMode.ShouldSimplifyHud ? 0 : JudgementCounterDisplay.TRANSFORM_DURATION, Easing.OutQuint);
        protected override void PopOut() => this.FadeOut(SkinPerformanceMode.ShouldSimplifyHud ? 0 : 100);
