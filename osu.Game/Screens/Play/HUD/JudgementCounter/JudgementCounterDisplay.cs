    ...
    public partial class JudgementCounterDisplay : CompositeDrawable, ISerialisableDrawable
    {
        ...
        private void updateDisplay()
        {
            ...
            bool shouldShow(int index, JudgementCounter counter)
            {
                ...
                return IsResultVisible(Mode.Value, counter.Result.Types.First());
            }
        }

        public static bool IsResultVisible(DisplayMode mode, HitResult hitResult)
        {
            switch (mode)
            {
        ...
        public enum DisplayMode
        {
            ...
            [LocalisableDescription(typeof(JudgementCounterDisplayStrings), nameof(JudgementCounterDisplayStrings.JudgementDisplayModeBonusesOnly))]
            BonusesOnly,
        }
    }
}
