...
namespace osu.Game.Screens.Play.HUD
{
    ...
    public partial class FailingLayer : HealthDisplay
    {
        ...
        private void updateState()
        {
            ...
            this.FadeTo(showLayer && !SkinPerformanceMode.ShouldSimplifyHud ? 1 : 0, SkinPerformanceMode.ShouldSimplifyHud ? 0 : fade_time, Easing.OutQuint);
        }
        ...
        protected override void Update()
        {
            ...
            boxes.Alpha = SkinPerformanceMode.ShouldSimplifyHud ? 0 : (float)Interpolation.Lerp(boxes.Alpha, target, Clock.ElapsedFrameTime * 0.01f);
        }
    }
}
