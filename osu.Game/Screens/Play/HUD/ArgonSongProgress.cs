...
namespace osu.Game.Screens.Play.HUD
{
    public partial class ArgonSongProgress : SongProgress
    {
        ...
        protected override void LoadComplete()
        {
            ...
            ShowTime.BindValueChanged(_ => info.FadeTo(ShowTime.Value ? 1 : 0, SkinPerformanceMode.ShouldSimplifyHud ? 0 : 200, Easing.In), true);
        ...
        {
            // The 5-tier additive SegmentedGraph layers 2-5 translucent passes over the full-width strip
            // every frame (est. 36-72k px/frame) for a low-contrast density readout — skip it in perf mode.
            bool show = ShowGraph.Value && !(SkinPerformanceMode.ShouldSimplifyHud && Performance.MosuOptimisationToggles.PerfSongProgressLite);

            graph.FadeTo(show ? 1 : 0, SkinPerformanceMode.ShouldSimplifyHud ? 0 : 200, Easing.In);
        }
