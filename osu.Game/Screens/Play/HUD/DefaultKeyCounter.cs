...
namespace osu.Game.Screens.Play.HUD
{
    public partial class DefaultKeyCounter : KeyCounter
    {
        ...
        private void updateGlowSprite(bool show)
        {
            if (show)
            {
                double remainingFadeTime = SkinPerformanceMode.ShouldSimplifyHud ? 0 : FadeTime * (1 - glowSprite.Alpha);
            ...
            {
                double remainingFadeTime = SkinPerformanceMode.ShouldSimplifyHud ? 0 : 8 * FadeTime * glowSprite.Alpha;
