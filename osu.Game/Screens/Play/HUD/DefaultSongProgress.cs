...
namespace osu.Game.Screens.Play.HUD
{
    public partial class DefaultSongProgress : SongProgress
    {
        ...
        private void updateGraphVisibility()
        {
            ...
            double duration = SkinPerformanceMode.ShouldSimplifyHud ? 0 : transition_duration;

            bar.ResizeHeightTo(ShowGraph.Value ? barHeight + graph_height : barHeight, duration, Easing.In);
            graph.FadeTo(ShowGraph.Value ? 1 : 0, duration, Easing.In);
        ...
        {
            info.FadeTo(ShowTime.Value ? 1 : 0, SkinPerformanceMode.ShouldSimplifyHud ? 0 : transition_duration, Easing.In);
        ...
        private void updateInfoMargin()
        {
            ...
            info.TransformTo(nameof(info.Margin), new MarginPadding { Bottom = finalMargin }, SkinPerformanceMode.ShouldSimplifyHud ? 0 : transition_duration, Easing.In);
        }
    }
}
