...
namespace osu.Game.Screens.Play
{
    public partial class ReplayFailIndicator : CompositeDrawable
    {
        ...
        private static readonly SampleInfo fail_sound_info = new SampleInfo("Gameplay/failsound");
        ...
        private void load(OsuColour colours, AudioManager audio, IBindable<WorkingBeatmap> beatmap, GameHost host)
        {
            ...
            {
                failSample = new SkinnableSound(fail_sound_info),
        ...
        public void Display()
        {
            ...
            using (BeginAbsoluteSequence(failTime.Value))
            {
                ...
                renderGameplaySampleTriggerRecorder?.RecordTrigger(gameplayClockContainer.CurrentTime);
                renderGameplayHitsoundRenderer?.PlaySamples(new[] { fail_sound_info });
                failSample.Play();
            }
        }
