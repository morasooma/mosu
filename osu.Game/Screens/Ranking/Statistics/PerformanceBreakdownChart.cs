...
namespace osu.Game.Screens.Ranking.Statistics
{
    public partial class PerformanceBreakdownChart : Container
    {
        ...
        private OsuSpriteText achievedLabel = null!;
        private OsuSpriteText maximumLabel = null!;
        private IBindable<Colour4> themeColour = null!;
        private PerformanceBreakdown? currentBreakdown;
        ...
        private void load()
        {
                        ...
                        new Drawable[]
                        {
                            ...
                            new GridContainer
                            {
                                ...
                                Content = new[]
                                {
                                    new Drawable[]
                                    {
                                        achievedLabel = new OsuSpriteText
                                        {
                                    ...
                                    new Drawable[]
                                    {
                                        maximumLabel = new OsuSpriteText
                                        {
                                            Origin = Anchor.CentreLeft,
                                            Anchor = Anchor.CentreLeft,
                                            Font = OsuFont.GetFont(weight: FontWeight.Regular, size: StatisticItem.FONT_SIZE),
            ...
            {
                achievedLabel.Colour = achievedPerformance.Colour = getAchievedColour();
                maximumLabel.Colour = maximumPerformance.Colour = getMaximumColour();

                if (currentBreakdown != null)
                    setPerformance(currentBreakdown);
            }, true);
        ...
        private Colour4 getAchievedColour() => OverlayColourProvider.IsLightTheme ? colourProvider.Content1 : Color4Extensions.FromHex("#66FFCC");
        private Colour4 getMaximumColour() => OverlayColourProvider.IsLightTheme ? colourProvider.Content2 : OsuColour.Gray(0.7f);
        ...
        private Drawable[]? createAttributeRow(PerformanceDisplayAttribute attribute, PerformanceDisplayAttribute perfectAttribute)
        {
            ...
            return new Drawable[]
            {
                new OsuSpriteText
                {
                    ...
                    Colour = OverlayColourProvider.IsLightTheme ? (Colour4)colourProvider.Content1 : Colour4.White
                },
                new Container
                {
                    ...
                    Child = new Bar
                    {
                        ...
                        Masking = true,
                        Height = 5,
                        BackgroundColour = (OverlayColourProvider.IsLightTheme ? colourProvider.Content1 : Color4.White).Opacity(0.5f),
