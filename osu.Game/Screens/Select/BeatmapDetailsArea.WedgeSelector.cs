    ...
    public partial class BeatmapDetailsArea
    {
            ...
            where T : struct, Enum
        {
            ...
            private void load(OverlayColourProvider colourProvider, OsuGameBase game)
            {
                ...
                themeColour.BindValueChanged(_ => strip.Colour = this.colourProvider.Highlight1, true);
            }
            ...
            protected partial class TabItem : TabItem<T>
            {
                ...
                private void updateDisplay()
                {
                    if (Active.Value || IsHovered)
                        Text.FadeColour(colourProvider.Content1, OverlayColourProvider.ThemeTransitionDuration(300), Easing.OutQuint);
                    else
                        Text.FadeColour(colourProvider.Content2, OverlayColourProvider.ThemeTransitionDuration(300), Easing.OutQuint);
