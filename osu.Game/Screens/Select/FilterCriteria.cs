...
namespace osu.Game.Screens.Select
{
    public class FilterCriteria
    {
        ...
        public OptionalRange<int> TotalObjects;
        public OptionalRange<double> PerformancePoints;
        public OptionalSet<BeatmapOnlineStatus> OnlineStatus = new OptionalSet<BeatmapOnlineStatus>();

        /// <summary>
        /// When <see langword="true"/>, only server-exclusive maps are matched
        /// (those with <see cref="BeatmapInfo.OnlineID"/> or beatmapset online ID >= 2,000,000,000).
        /// </summary>
        public bool ServerExclusive;
        ...
        public HashSet<int> ManiaKeyCounts = [];
