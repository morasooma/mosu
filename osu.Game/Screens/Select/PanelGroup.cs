...
namespace osu.Game.Screens.Select
{
    public partial class PanelGroup : Panel
    {
        ...
        private void load(OsuConfigManager config)
        {
            ...
            {
                iconContainer.Colour = colourProvider.Background3;
        ...
        {
            double duration = OverlayColourProvider.ThemeTransitionDuration(500);
            ...
            glow.FadeTo(!useSkinnedLegacyCarousel.Value && Expanded.Value ? 0.4f : 0, duration, Easing.OutQuint);
        }
