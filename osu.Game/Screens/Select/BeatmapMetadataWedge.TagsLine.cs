...
namespace osu.Game.Screens.Select
{
    public partial class BeatmapMetadataWedge
    {
        private partial class TagsLine : FillFlowContainer
        {
            ...
            private void load()
            {
                themeColour = colourProvider.GetColourBindable(OverlayColour.Light2);
                themeColour.BindValueChanged(_ => updateTags(), true);
            }
            ...
            private partial class TagsOverflowButton : CompositeDrawable, IHasPopover, IHasLineBaseHeight
            {
                ...
                private void load()
                {
                    ...
                    themeColour = colourProvider.GetColourBindable(OverlayColour.Light1);
                    themeColour.BindValueChanged(_ => updateColours(), true);
                }

                private void updateColours()
                {
                    box.Colour = IsHovered ? colourProvider.Content2 : colourProvider.Light1;
                    text.Colour = colourProvider.Background4;
                }

                protected override bool OnHover(HoverEvent e)
                {
                    box.FadeColour(colourProvider.Content2, OverlayColourProvider.ThemeTransitionDuration(300), Easing.OutQuint);
                    return base.OnHover(e);
                }

                protected override void OnHoverLost(HoverLostEvent e)
                {
                    box.FadeColour(colourProvider.Light1, OverlayColourProvider.ThemeTransitionDuration(300), Easing.OutQuint);
                    base.OnHoverLost(e);
                }
