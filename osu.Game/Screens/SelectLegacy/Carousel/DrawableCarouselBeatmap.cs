...
namespace osu.Game.Screens.SelectLegacy.Carousel
{
    public partial class DrawableCarouselBeatmap : DrawableCarouselItem, IHasContextMenu
    {
        ...
        private void load(SongSelect? songSelect, OsuConfigManager config)
        {
            this.config = config;
                                ...
                                new FillFlowContainer
                                {
                                    ...
                                    Children = new Drawable[]
                                    {
                                        ...
                                        additionalStatsText = new OsuSpriteText
                                        {
                                            ...
                                            Margin = new MarginPadding { Left = 6, Top = 2 },
                                            Alpha = 0,
                                        }
                                    }
                                }
        ...
        protected override void ApplyState()
        {
            ...
            if (Item?.State.Value != CarouselItemState.Collapsed)
            {
                ...
                starDifficultyBindable.BindValueChanged(d =>
                {
                    ...
                    updateAdditionalInfoText(d.NewValue);
                }, true);
        ...
        private void updateKeyCount()
        {
            ...
            if (ManiaBeatmapSummary.Create(beatmapInfo, ruleset.Value, mods.Value) is { } maniaSummary)
            {
                keyCountText.Alpha = 1;
                keyCountText.Text = $"[{maniaSummary.KeyCount}K]";
            }
            else
            {
