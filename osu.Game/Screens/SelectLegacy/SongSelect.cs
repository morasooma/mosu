...
using osu.Game.Screens.SelectLegacy.Options;
...
namespace osu.Game.Screens.SelectLegacy
{
    public abstract partial class SongSelect : ScreenWithBeatmapBackground, IKeyBindingHandler<GlobalAction>
    {
        ...
        /// <summary>
        /// Cached for embedded sheared components (e.g. the collection dropdown in the filter control),
        /// which require an overlay colour provider to resolve dependencies.
        /// </summary>
        [Cached]
        ...
        private void load(AudioManager audio, OsuColour colours, ManageCollectionsDialog? manageCollectionsDialog, DifficultyRecommender? recommender, OsuConfigManager config)
        {
            ...
            carouselBackgroundDim.BindValueChanged(e =>
            {
                if (!this.IsCurrentScreen())
                    return;
                                ...
                                new Drawable[]
                                {
                                    ...
                                    carouselContainer = new Container
                                    {
                                        ...
                                        Padding = new MarginPadding
                                        {
                                            ...
                                            Bottom = SelectLegacy.Footer.HEIGHT
                                        },
            ...
            LoadComponentAsync(Carousel = new BeatmapCarousel(FilterControl.CreateCriteria())
            {
                ...
                BleedBottom = SelectLegacy.Footer.HEIGHT,
            ...
            if (ShowSongSelectFooter)
            {
                AddRangeInternal(new Drawable[]
                {
                    FooterPanels = new Container
                    {
                        ...
                        Origin = Anchor.BottomLeft,
                        RelativeSizeAxes = Axes.Both,
                        Padding = new MarginPadding { Bottom = SelectLegacy.Footer.HEIGHT },
                        Children = new Drawable[]
                        {
