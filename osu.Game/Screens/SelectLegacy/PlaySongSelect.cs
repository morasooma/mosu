...
namespace osu.Game.Screens.SelectLegacy
{
    public partial class PlaySongSelect : SongSelect
    {
        ...
        private void load(OsuColour colours, OsuConfigManager config)
        {
            ...
            // GetBindable() returns a weakly-bound copy, so this must be retained for the
            // lifetime of the screen or the change handler may be collected.
            ...
            songSelectStyle.BindValueChanged(e => Schedule(() =>
            {
                ...
                // Swap back to the current song select implementation immediately
                // (no-op if the new style still maps to this same screen type).
                if (e.NewValue.UsesV1Screen() == e.OldValue.UsesV1Screen())
                    return;
