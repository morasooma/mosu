    ...
    public partial class PlaylistsRoomSettingsOverlay : RoomSettingsOverlay
    {
        ...
        protected partial class MatchSettings : CompositeDrawable
        {
            ...
            private void updateRoomDuration()
                => DurationField.Current.Value = room.Duration ?? TimeSpan.FromDays(36500);
            ...
            private bool hasValidDuration => DurationField.Current.Value == TimeSpan.FromDays(36500) || DurationField.Current.Value <= TimeSpan.FromDays(14) || localUser.Value.IsSupporter;
        ...
        private partial class DurationDropdown : OsuDropdown<TimeSpan>
        {
            ...
            {
                if (item == TimeSpan.FromDays(36500))
                    return "Никогда";
                return item.Humanize(maxUnit: TimeUnit.Month);
            }
        }
    }
}
