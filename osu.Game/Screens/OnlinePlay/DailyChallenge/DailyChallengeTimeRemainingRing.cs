...
namespace osu.Game.Screens.OnlinePlay.DailyChallenge
{
    public partial class DailyChallengeTimeRemainingRing : CompositeDrawable
    {
        ...
        private CircularProgress backgroundProgress = null!;
        private OsuSpriteText timeText = null!;
        private OsuSpriteText remainingText = null!;
                    ...
                    Children = new Drawable[]
                    {
                        ...
                        new FillFlowContainer
                        {
                            ...
                            Children = new[]
                            {
                                ...
                                remainingText = new OsuSpriteText
                                {
                                    Text = "remaining",
        ...
        protected override void LoadComplete()
        {
            ...
            {
                backgroundProgress.Colour = colourProvider.Background5;
                remainingText.Colour = OverlayColourProvider.IsLightTheme ? colourProvider.Content1 : Colour4.White;
                updateState();
            }, true);
        ...
        private void updateState()
        {
            ...
            {
                timeText.FadeColour(OverlayColourProvider.IsLightTheme ? (Colour4)colourProvider.Content1 : Colour4.White, transition_duration, Easing.OutQuint);
