...
namespace osu.Game.Screens.OnlinePlay.Matchmaking.RankedPlay.Card
{
    public partial class RankedPlayCard
    {
        public partial class SongPreviewContainer : Container, IBeatSyncProvider
        {
            ...
            {
                // Playlist item updates (for example, when a server-selected mod is applied)
                // may reveal the same card more than once. The preview is already valid and
                // must not be loaded into this container a second time.
