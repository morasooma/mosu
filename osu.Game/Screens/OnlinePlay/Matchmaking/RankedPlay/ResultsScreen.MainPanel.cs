        ...
        private partial class MainPanel : CompositeDrawable
        {
            ...
            private void load(AudioManager audio)
            {
                ...
                AddInternal(sampleContainer = new AudioContainer
                {
                    ...
                    {
                        resultsAppearSample = createSample(audio, @"Multiplayer/Matchmaking/Ranked/Results/results-appear"),
                        dmgFlySample = createSample(audio, @"Multiplayer/Matchmaking/Ranked/Results/dmg-fly"),
                        dmgHitSample = createSample(audio, @"Multiplayer/Matchmaking/Ranked/Results/dmg-hit"),
                        damageMultiplierSample = createSample(audio, @"Multiplayer/Matchmaking/Ranked/Results/dmg-multiplier"),
                        damageMultiplierUpSample = createSample(audio, @"Multiplayer/Matchmaking/Ranked/Results/dmg-multiplier-up"),
                        damageMultiplierDownSample = createSample(audio, @"Multiplayer/Matchmaking/Ranked/Results/dmg-multiplier-down"),
                        hpDownSample = createSample(audio, @"Multiplayer/Matchmaking/Ranked/Results/hp-down"),
                        playerAppearSample = createSample(audio, @"Multiplayer/Matchmaking/Ranked/Results/players-appear"),
                        pseudoScoreCounterSample = createSample(audio, @"Multiplayer/Matchmaking/Ranked/Results/pseudo-score-counter"),
                        scoreTickSample = createSample(audio, @"Multiplayer/Matchmaking/Ranked/Results/score-tick"),
                        gradePassSample = createSample(audio, @"Results/rank-impact-pass"),
                        gradePassSsSample = createSample(audio, @"Results/rank-impact-pass-ss"),
                        gradeFailSample = createSample(audio, @"Results/rank-impact-fail"),
                        gradeFailDSample = createSample(audio, @"Results/rank-impact-fail-d"),
                    }
                });
            }

            private static DrawableSample createSample(AudioManager audio, string name)
                => new DrawableSample(audio.Samples.Get(name) ?? new SampleVirtual(name));
