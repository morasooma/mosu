...
namespace osu.Game.Screens.OnlinePlay.Matchmaking.Queue
{
    public partial class PoolSelector : CompositeDrawable
    {
        ...
        private partial class SelectorButton : OsuAnimatedButton
        {
            ...
            private OsuSpriteText rulesetNameText = null!;
            private OsuSpriteText poolNameText = null!;
            ...
            private void load(OverlayColourProvider colourProvider)
            {
                    ...
                    new FillFlowContainer
                    {
                        ...
                        Children = new Drawable[]
                        {
                            ...
                            new FillFlowContainer
                            {
                                ...
                                Children = new Drawable[]
                                {
                                    rulesetNameText = new OsuSpriteText
                                    {
                                        Anchor = Anchor.TopCentre,
                                        Origin = Anchor.TopCentre,
                                    ...
                                    poolNameText = new OsuSpriteText
                                    {
                                        Anchor = Anchor.TopCentre,
                                        Origin = Anchor.TopCentre,
                ...
                {
                    rulesetNameText.Colour = poolNameText.Colour = OverlayColourProvider.IsLightTheme ? colourProvider.Content1 : Color4.White;
                    backgroundBox.Colour = colourProvider.Background2;
                }, true);
