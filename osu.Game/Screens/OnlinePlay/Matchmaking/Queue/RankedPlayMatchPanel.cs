...
namespace osu.Game.Screens.OnlinePlay.Matchmaking.Queue
{
    public partial class RankedPlayMatchPanel : CompositeDrawable
    {
        ...
        private FillFlowContainer userLeft = null!;
        private FillFlowContainer userRight = null!;
        ...
        private void load()
        {
            ...
            else if (leftWin)
            {
                ...
                leftLifeText.Colour = userLeft.Colour = getContentColour(0.4f);
            ...
            else if (rightWin)
            {
                ...
                rightLifeText.Colour = userRight.Colour = getContentColour(0.4f);
