...
namespace osu.Game.Screens.OnlinePlay.Multiplayer.Participants
{
    ...
    public record Slot
    {
        ...
        private Slot(bool isEmpty, bool isLocked, MultiplayerRoomUser? user, byte? slotId)
        {
            IsEmpty = isEmpty;
            IsLocked = isLocked;
            User = user;
        ...
        public static Slot FromUser(MultiplayerRoomUser user) => new Slot(false, false, user, null);

        public static Slot Empty(byte slotId) => new Slot(true, false, null, slotId);

        public static Slot Locked(byte slotId) => new Slot(true, true, null, slotId);
    }
}
