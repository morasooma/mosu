...
namespace osu.Game.Screens.OnlinePlay.Multiplayer.Participants
{
    public partial class ParticipantPanel : PoolableDrawable, IHasContextMenu, IHasCurrentValue<Slot>
    {
        ...
        private OsuSpriteText emptySlotText = null!;
                    ...
                    new Drawable[]
                    {
                        ...
                        new Container
                        {
                            ...
                            Children = new Drawable[]
                            {
                                ...
                                {
                                    RelativeSizeAxes = Axes.Both,
                                    Child = emptySlotText = new OsuSpriteText
                                    {
        ...
        private void updateUser()
        {
            ...
            emptySlotText.Text = current.Value.IsLocked ? "Closed slot" : MultiplayerMatchStrings.EmptySlot;
        ...
        {
            if (!current.Value.IsEmpty || current.Value.IsLocked)
                return;
