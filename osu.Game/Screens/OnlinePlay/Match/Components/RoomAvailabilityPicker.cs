...
namespace osu.Game.Screens.OnlinePlay.Match.Components
{
    public partial class RoomAvailabilityPicker : DisableableTabControl<RoomAvailability>
    {
        ...
        private partial class RoomAvailabilityPickerItem : DisableableTabItem
        {
            ...
            private readonly Box hover, selection, background;
            ...
            private void load(OsuColour colours, OverlayColourProvider colourProvider)
            {
                ...
                themeColour.BindValueChanged(_ => text.Colour = OverlayColourProvider.IsLightTheme ? colourProvider.Content1 : Color4.White, true);
            }
