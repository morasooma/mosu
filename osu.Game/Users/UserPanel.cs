...
namespace osu.Game.Users
{
    public abstract partial class UserPanel : OsuClickableContainer, IHasContextMenu, IFilterable
    {
        ...
        private readonly List<OsuSpriteText> usernameTexts = new List<OsuSpriteText>();
        private IBindable<Colour4>? backgroundColour;
        private IBindable<Colour4>? contentColour;
        ...
        private void load()
        {
            ...
            {
                backgroundColour = ColourProvider.GetColourBindable(OverlayColour.Background5);
                backgroundColour.BindValueChanged(colour => panelBackground.Colour = colour.NewValue, true);

                contentColour = ColourProvider.GetColourBindable(OverlayColour.Content1);
                contentColour.BindValueChanged(colour =>
                {
