...
namespace osu.Game.Overlays.BeatmapListing
{
    public partial class BeatmapListingFilterControl : CompositeDrawable
    {
        ...
        private void load(OverlayColourProvider colourProvider, IAPIProvider api)
        {
            ...
            themeColour.BindValueChanged(colour => sortControlBackground.Colour = colour.NewValue, true);
        }
        ...
        private void performRequest()
        {
            ...
            request.Success += response =>
            {
                ...
                APIUser searchUser = !serverExclusiveOnly && beatmapApi.OfficialApi?.IsAvailable == true
                    ? beatmapApi.OfficialApi.LocalUser.Value
                    : api.LocalUser.Value;

                if (!searchUser.IsSupporter)
                {
