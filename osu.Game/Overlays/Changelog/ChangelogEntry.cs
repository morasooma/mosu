...
namespace osu.Game.Overlays.Changelog
{
    public partial class ChangelogEntry : FillFlowContainer
    {
        ...
        private void load()
        {
            ...
            themeColour.BindValueChanged(_ => recreateDrawables(), true);
        }
        ...
        {
            var entryColour = entry.Major ? colours.YellowLight : (OverlayColourProvider.IsLightTheme ? colourProvider.Content1 : Color4.White);
