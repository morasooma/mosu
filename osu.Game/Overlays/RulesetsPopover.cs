...
namespace osu.Game.Overlays
{
    public partial class RulesetsPopover : OsuPopover
    {
        ...
        private OsuMenuItem[] items =>
            ...
            {
                RulesetInfo.OSU_MODE_SHORTNAME => Online.MosuServerEnvironment.OnlyOsuRelax
                    ? new OsuMenuItem[]
                    {
                ...
                RulesetInfo.TAIKO_MODE_SHORTNAME => Online.MosuServerEnvironment.OnlyOsuRelax
                    ? []
                    : new OsuMenuItem[]
                    {
                        new RulesetMenuItem(overlayRulesetSelector, rulesetInfo, Hide),
                ...
                RulesetInfo.CATCH_MODE_SHORTNAME => Online.MosuServerEnvironment.OnlyOsuRelax
                    ? []
                    : new OsuMenuItem[]
                    {
                        new RulesetMenuItem(overlayRulesetSelector, rulesetInfo, Hide),
