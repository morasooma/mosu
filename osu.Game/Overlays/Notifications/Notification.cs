...
namespace osu.Game.Overlays.Notifications
{
    public abstract partial class Notification : Container
    {
        ...
        private void load()
        {
            ...
            themeColour.BindValueChanged(_ => background.Colour = colourProvider.Background3, true);
        }

        protected override bool OnHover(HoverEvent e)
        {
            background.FadeColour(colourProvider.Background2, OverlayColourProvider.ThemeTransitionDuration(200), Easing.OutQuint);
            return base.OnHover(e);
        }

        protected override void OnHoverLost(HoverLostEvent e)
        {
            background.FadeColour(colourProvider.Background3, OverlayColourProvider.ThemeTransitionDuration(200), Easing.OutQuint);
            base.OnHoverLost(e);
        }
        ...
        internal partial class CloseButton : OsuClickableContainer
        {
            ...
            private void load()
            {
                ...
                themeColour.BindValueChanged(_ => icon.Colour = colourProvider.Foreground1, true);
            }

            protected override bool OnHover(HoverEvent e)
            {
                background.FadeIn(OverlayColourProvider.ThemeTransitionDuration(200), Easing.OutQuint);
                icon.FadeColour(colourProvider.Content1, OverlayColourProvider.ThemeTransitionDuration(200), Easing.OutQuint);
                return base.OnHover(e);
            }

            protected override void OnHoverLost(HoverLostEvent e)
            {
                background.FadeOut(OverlayColourProvider.ThemeTransitionDuration(200), Easing.OutQuint);
                icon.FadeColour(colourProvider.Foreground1, OverlayColourProvider.ThemeTransitionDuration(200), Easing.OutQuint);
                base.OnHoverLost(e);
            }
        }
