...
namespace osu.Game.Overlays.Notifications
{
    public partial class NotificationSection : AlwaysUpdateFillFlowContainer<Drawable>
    {
        ...
        private OsuSpriteText titleDrawable = null!;
        private ClearAllButton clearAllButton = null!;
        ...
        private void load(OsuColour colours, OverlayColourProvider colourProvider)
        {
            ...
            AddRangeInternal(new Drawable[]
            {
                new Container
                {
                    ...
                    {
                        clearAllButton = new ClearAllButton
                        {
                        ...
                        new FillFlowContainer
                        {
                            ...
                            Children = new Drawable[]
                            {
                                titleDrawable = new OsuSpriteText
                                {
            ...
            {
                Color4 titleColour = OverlayColourProvider.IsLightTheme ? colourProvider.Content1 : Color4.White;
                titleDrawable.Colour = titleColour;
                clearAllButton.Colour = titleColour;
            }, true);
        }
