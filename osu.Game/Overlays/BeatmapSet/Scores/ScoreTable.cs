...
namespace osu.Game.Overlays.BeatmapSet.Scores
{
    public partial class ScoreTable : TableContainer
    {
        ...
        private IReadOnlyList<ScoreInfo> displayedScores = null;
        ...
        private void load()
        {
            ...
            themeColour.BindValueChanged(_ =>
            {
                if (displayedScores != null)
                    DisplayScores(displayedScores, showPerformancePoints);
            });
        }
...
#pragma warning restore 618
            ...
            foreach (var columnName in statisticResultNames)
            {
                ...
                content.Add(new StatisticText(count, maxCount, @"N0") { Colour = count == 0 ? Color4.Gray : (OverlayColourProvider.IsLightTheme ? (Color4)colourProvider.Content1 : Color4.White) });
            }
