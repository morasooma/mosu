...
namespace osu.Game.Overlays.Profile.Header.Components
{
    public partial class MatchmakingStatsTooltip : VisibilityContainer, ITooltip<MatchmakingStatsTooltipData>
    {
        ...
        private MatchmakingStatsTooltipData? currentContent;
        ...
        public void SetContent(MatchmakingStatsTooltipData content)
        {
            ...
            if (themeColour == null)
            {
                themeColour = content.ColourProvider.GetColourBindable(OverlayColour.Content1);
        ...
        private void updateContent(MatchmakingStatsTooltipData content)
        {
