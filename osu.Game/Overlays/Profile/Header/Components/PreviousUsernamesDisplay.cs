...
namespace osu.Game.Overlays.Profile.Header.Components
{
    public partial class PreviousUsernamesDisplay : CompositeDrawable
    {
        ...
        {
            themeColour = colours.GetColourBindable(OverlayColour.Content1);
            themeColour.BindValueChanged(_ =>
            {
                background.Colour = colours.Background6;
                header.Colour = colours.Content2;
                text.Colour = colours.Content1;
                hoverIcon.Colour = colours.Content1;
            }, true);
        }
