...
namespace osu.Game.Overlays.Profile.Header.Components
{
    public partial class DailyChallengeStatsDisplay : CompositeDrawable, IHasCustomTooltip<DailyChallengeTooltipData>
    {
        ...
        private OsuTextFlowContainer label = null!;
        private Box contentBackground = null!;
        private Box countBackground = null!;
        private SpriteIcon completionIcon = null!;
        ...
        private void load(LocalisationManager localisationManager)
        {
            ...
            themeColour.BindValueChanged(_ =>
            {
                ...
                countBackground.Colour = colourProvider.Background6;
                label.Colour = colourProvider.Content1;
                completionIcon.Colour = colourProvider.Background6;
            }, true);
