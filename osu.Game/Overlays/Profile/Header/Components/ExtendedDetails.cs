...
namespace osu.Game.Overlays.Profile.Header.Components
{
    public partial class ExtendedDetails : CompositeDrawable
    {
        ...
        private FillFlowContainer labels = null!;
        private FillFlowContainer values = null!;
        ...
        private void load()
        {
            ...
            {
                labels.Colour = colourProvider.Content1;
                values.Colour = colourProvider.Content2;
            }, true);
        }
