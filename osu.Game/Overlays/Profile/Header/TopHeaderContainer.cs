...
namespace osu.Game.Overlays.Profile.Header
{
    public partial class TopHeaderContainer : CompositeDrawable
    {
        ...
        private void updateThemeColours()
        {
            ...
            usernameText.Colour = userCountryText.Colour = teamText.Colour = OverlayColourProvider.IsLightTheme ? colourProvider.Content1 : Color4.White;
        ...
        private void updateUser(UserProfileData? data)
        {
            ...
            titleText.Colour = Color4Extensions.FromHex(user?.Colour ?? (OverlayColourProvider.IsLightTheme ? colourProvider.Content1.ToHex() : "fff"));
