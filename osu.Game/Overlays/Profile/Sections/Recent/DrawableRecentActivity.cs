...
namespace osu.Game.Overlays.Profile.Sections.Recent
{
    public partial class DrawableRecentActivity : CompositeDrawable
    {
        ...
        private DrawableDate date = null!;
                ...
                Content = new[]
                {
                    new Drawable[]
                    {
                        ...
                        content = new LinkFlowContainer(t =>
                        {
                            ...
                            t.Colour = OverlayColourProvider.IsLightTheme ? colourProvider.Content1 : Color4.White;
                        })
                        {
                        ...
                        date = new DrawableDate(activity.CreatedAt)
                        {
