...
namespace osu.Game.Overlays.Profile.Sections.Ranks
{
    public partial class DrawableProfileScore : CompositeDrawable
    {
        ...
        private SpriteText[] themedText = Array.Empty<SpriteText>();
        ...
        private void load(RulesetStore rulesets)
        {
            ...
            themedText = this.ChildrenOfType<SpriteText>().Where(text => text.Colour == Color4.White).ToArray();
            themeColour = colourProvider.GetColourBindable(OverlayColour.Content1);
            themeColour.BindValueChanged(colour =>
            {
                foreach (var text in themedText)
