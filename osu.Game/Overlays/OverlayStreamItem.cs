...
namespace osu.Game.Overlays
{
    public abstract partial class OverlayStreamItem<T> : TabItem<T>
    {
        ...
        private void load(OverlayColourProvider colourProvider, OsuColour colours, AudioManager audio)
        {
            ...
            {
                mainTextPiece.Colour = colourProvider.Content1;
                additionalTextPiece.Colour = colourProvider.Content2;
                infoTextPiece.Colour = colourProvider.Foreground1;

                Color4 barColour = GetBarColour(colours);
                expandingBar.Colour = OverlayColourProvider.IsLightTheme && barColour == Color4.White
