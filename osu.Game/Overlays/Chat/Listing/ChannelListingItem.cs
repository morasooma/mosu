...
namespace osu.Game.Overlays.Chat.Listing
{
    public partial class ChannelListingItem : OsuClickableContainer, IFilterable
    {
        ...
        private SpriteIcon userIcon = null!;
        private OsuSpriteText channelText = null!;
        private OsuSpriteText userCountText = null!;
                ...
                new GridContainer
                {
                    ...
                    Content = new[]
                    {
                        new Drawable[]
                        {
                            ...
                            userCountText = new OsuSpriteText
                            {
                                Anchor = Anchor.CentreLeft,
                                Origin = Anchor.CentreLeft,
                                Text = "0",
        ...
        {
            bool joined = channelJoined?.Value == true;
            Colour4 joinedTextColour = OverlayColourProvider.IsLightTheme ? (Colour4)colourProvider.Content1 : Colour4.White;

            channelText.Colour = topicText.Colour = joined ? joinedTextColour : colourProvider.Content2;
            userIcon.Colour = userCountText.Colour = colourProvider.Light3;
        }
