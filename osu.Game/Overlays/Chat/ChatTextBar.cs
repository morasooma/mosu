...
namespace osu.Game.Overlays.Chat
{
    public partial class ChatTextBar : Container
    {
        ...
        private SpriteIcon searchIcon = null!;
                    ...
                    Content = new[]
                    {
                        new Drawable[]
                        {
                            ...
                            searchIconContainer = new Container
                            {
                                ...
                                Child = searchIcon = new SpriteIcon
                                {
        ...
        protected override void LoadComplete()
        {
            ...
            themeColour.BindValueChanged(_ =>
            {
                ...
                chattingText.Colour = colourProvider.Background1;
                searchIcon.Colour = colourProvider.Content1;
            }, true);
