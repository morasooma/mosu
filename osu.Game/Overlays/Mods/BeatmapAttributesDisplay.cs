...
namespace osu.Game.Overlays.Mods
{
    ...
    public partial class BeatmapAttributesDisplay : ModFooterInformationDisplay
    {
        ...
        private CancellationTokenSource? bpmCancellationSource;
        ...
        protected override void LoadComplete()
        {
            ...
            WorkingBeatmap.BindValueChanged(_ => updateBpm(), true);
        ...
        private void updateBpm()
        {
            ...
            bpmCancellationSource?.Cancel();
            bpmCancellationSource = new CancellationTokenSource();
            var token = bpmCancellationSource.Token;
            ...
            Task.Run(() =>
            {
                ...
                if (beatLength <= 0 || !double.IsFinite(beatLength))
                    return;

                int bpm = FormatUtils.RoundBPM(60000 / beatLength, rate);
