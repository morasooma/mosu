...
namespace osu.Game.Overlays.Mods
{
    public partial class VerticalAttributeDisplay : Container, IHasCustomTooltip<RulesetBeatmapAttribute?>
    {
        ...
        private ModEffect currentEffect;
        ...
        private void updateTextColor(ModEffect effect)
        {
            ...
            switch (effect)
            {
                case ModEffect.NotChanged:
                    newColor = OverlayColourProvider.IsLightTheme ? (colourProvider?.Content1 ?? Color4.Black) : Color4.White;
                    break;
        ...
        private void loadTheme()
        {
            if (colourProvider != null)
            {
                ...
                themeColour.BindValueChanged(_ => updateTextColor(currentEffect), true);
            }
        }
