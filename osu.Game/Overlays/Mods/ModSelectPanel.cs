...
namespace osu.Game.Overlays.Mods
{
    public abstract partial class ModSelectPanel : OsuClickableContainer, IHasAccentColour, IFilterable
    {
        ...
        protected virtual Colour4 BackgroundColour => Active.Value
            ? AccentColour.Darken(0.3f)
        ...
        protected virtual Colour4 TextColour => Active.Value
            ? ColourProvider.GetDefaultColour(0.1f, 0.1f)
        ...
        protected OsuSpriteText DescriptionText => descriptionText;
        ...
        protected virtual void UpdateState()
        {
            ...
            double transitionDuration = OverlayColourProvider.ThemeTransitionDuration(TRANSITION_DURATION);
