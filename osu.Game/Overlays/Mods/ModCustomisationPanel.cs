...
namespace osu.Game.Overlays.Mods
{
    public partial class ModCustomisationPanel : OverlayContainer, IKeyBindingHandler<GlobalAction>
    {
        ...
        private IBindable<bool> allowNumericInput = null!;
        ...
        private IReadOnlyList<Mod> displayedMods = Array.Empty<Mod>();
        ...
        {
            allowNumericInput = config.GetBindable<bool>(OsuSetting.ForkEnableModNumericInput);
        ...
        protected override void LoadComplete()
        {
            ...
            SelectedMods.BindValueChanged(_ => updateModsIfSelectionChanged(), true);
            allowNumericInput.BindValueChanged(_ => updateMods());
            themeColour = colourProvider.GetColourBindable(OverlayColour.Dark3);
            themeColour.BindValueChanged(_ =>
            {
                content.BorderColour = colourProvider.Dark3;
        ...
        {
            displayedMods = SelectedMods.Value.ToArray();
            ...
            {
                var settings = mod.CreateSettingsControls(allowNumericInput.Value).ToList();
        ...
        private void updateModsIfSelectionChanged()
        {
            if (displayedMods.SequenceEqual(SelectedMods.Value, ReferenceEqualityComparer.Instance))
                return;
