...
namespace osu.Game.Overlays.Mods
{
    internal partial class EditPresetPopover : OsuPopover
    {
        ...
        private Box modsBackground = null!;
        ...
        private void load()
        {
                    ...
                    new FillFlowContainer
                    {
                        ...
                        Children = new Drawable[]
                        {
                            useCurrentModsButton = new ShearedButton
                            {
                                ...
                                TextColour = colourProvider.GetDefaultColour(0.1f, 0.1f),
            ...
            themeColour.BindValueChanged(colour => modsBackground.Colour = colour.NewValue, true);
