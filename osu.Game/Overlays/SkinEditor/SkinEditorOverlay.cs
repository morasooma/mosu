...
namespace osu.Game.Overlays.SkinEditor
{
    ...
    public partial class SkinEditorOverlay : OverlayContainer, IKeyBindingHandler<GlobalAction>
    {
        ...
        /// <summary>
        /// Mounts a skin for external editing and opens its <c>skin.ini</c> file.
        /// </summary>
        public async Task EditSkinIniExternally(SkinInfo skinInfo)
        {
            Task editOperation = await externalEditOverlay.Begin(skinInfo, openSkinIni: true).ConfigureAwait(false);
            await editOperation.ConfigureAwait(false);
        }
