...
namespace osu.Game.Overlays.Toolbar
{
    public partial class ToolbarUserButton : ToolbarOverlayToggleButton
    {
        ...
        private IBindable<string> customUsername = null!;
        ...
        private void load(OsuColour colours, IAPIProvider api, LoginOverlay? login, OsuConfigManager config)
        {
            ...
            customUsername.BindValueChanged(_ => updateUserDisplay(), true);

            StateContainer = login;
        }

        private void updateUserDisplay() => Schedule(() =>
        {
            var user = localUser.Value;
            usernameText.Text = user.GetDisplayUsername(customUsername.Value);
            avatar.User = user;
        });
