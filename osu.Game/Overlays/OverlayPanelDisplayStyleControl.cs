    ...
    public partial class OverlayPanelDisplayStyleControl : OsuTabControl<OverlayPanelDisplayStyle>
    {
        ...
        private partial class PanelDisplayTabItem : TabItem<OverlayPanelDisplayStyle>, IHasTooltip
        {
            ...
            private void load(AudioManager audio)
            {
                ...
                themeMode.BindValueChanged(_ => updateState(), true);
            }
            ...
            private void updateState() => icon.Colour = Active.Value || IsHovered ? colourProvider.Light1 : (OverlayColourProvider.IsLightTheme ? colourProvider.Content1 : Color4.White);
        }
    }
