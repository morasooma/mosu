...
namespace osu.Game.Overlays.Dashboard.Home
{
    public abstract partial class DashboardBeatmapPanel : OsuClickableContainer
    {
        ...
        private TruncatingSpriteText artistText;
                                ...
                                new Container
                                {
                                    ...
                                    Child = new FillFlowContainer
                                    {
                                        ...
                                        Children = new Drawable[]
                                        {
                                            ...
                                            {
                                                c.AddText("by", t => t.Colour = ColourProvider.Content2);
        ...
        {
            hoverBackground.Colour = ColourProvider.Background3;
            titleText.Colour = ColourProvider.Content1;
            artistText.Colour = ColourProvider.Content2;
            chevron.Colour = IsHovered ? ColourProvider.Light1 : ColourProvider.Foreground1;
        }
