...
namespace osu.Game.Overlays
{
    public partial class OverlaySortTabControl<T> : CompositeDrawable, IHasCurrentValue<T>
    {
        ...
        private void load(OverlayColourProvider colourProvider)
        {
            ...
            themeColour.BindValueChanged(colour => text.Colour = colour.NewValue, true);
        }
        ...
        public partial class TabButton : HeaderButton
        {
            ...
            protected virtual void UpdateState()
            {
                ...
                ContentColour = Active.Value && !IsHovered ? colourProvider.Light1 : (OverlayColourProvider.IsLightTheme ? colourProvider.Content1 : Color4.White);
