                    ...
                    Children = new Drawable[]
                    {
                        new Container
                        {
                            ...
                            Children = new Drawable[]
                            {
                                ...
                                {
                                    RelativeSizeAxes = Axes.Both,
                                    SurfaceColour = Color4Extensions.FromHex(@"221a21"),
                                },
                                new Triangles
                                {
                                    RelativeSizeAxes = Axes.Both,
                                    ColourLight = Color4Extensions.FromHex(@"271e26").Opacity(0.28f),
                                    ColourDark = Color4Extensions.FromHex(@"1e171e").Opacity(0.28f),
                                    TriangleScale = 4,
                                },
                                flashLayer = new Box
                                {
