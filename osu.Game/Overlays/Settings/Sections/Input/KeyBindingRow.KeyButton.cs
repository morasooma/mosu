    ...
    public partial class KeyBindingRow
    {
        public partial class KeyButton : Container
        {
            ...
            private void load()
            {
                ...
                themeColour.BindValueChanged(_ => updateHoverState(), true);
            ...
            private void updateHoverState()
            {
                ...
                if (isBinding)
                {
                    ...
                    Text.FadeColour(OverlayColourProvider.IsLightTheme ? Color4.White : Color4.Black, transition_time, Easing.OutQuint);
                }
                else
                {
                    box.FadeColour(IsHovered ? colourProvider.Light4 : colourProvider.Background6, transition_time, Easing.OutQuint);
                    Text.FadeColour((IsHovered ^ OverlayColourProvider.IsLightTheme) ? Color4.Black : Color4.White, transition_time, Easing.OutQuint);
