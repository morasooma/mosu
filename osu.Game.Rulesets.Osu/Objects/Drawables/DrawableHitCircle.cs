...
namespace osu.Game.Rulesets.Osu.Objects.Drawables
{
    public partial class DrawableHitCircle : DrawableOsuHitObject, IHasApproachCircle
    {
        ...
        private void load(OsuRulesetConfigManager? osuConfig)
        {
            ...
            {
                scaleContainer = new StableLifetimeContainer
                {
                    ...
                    Children = new Drawable[]
                    {
                        ...
                        {
                            CanBeHit = () => !AllJudged,
                            GetPositionalMissTimeOffset = () =>
                            {
                                double timeOffset = Time.Current - HitObject.StartTime;
                                return ResultFor(timeOffset) == HitResult.None ? null : timeOffset;
                            },
        ...
        public partial class HitReceptor : CompositeDrawable, IKeyBindingHandler<OsuAction>
        {
            ...
            /// <summary>
            /// Returns the current timing offset when a press outside this receptor should be shown as a positional miss.
            /// </summary>
            public required Func<double?> GetPositionalMissTimeOffset { get; set; }
