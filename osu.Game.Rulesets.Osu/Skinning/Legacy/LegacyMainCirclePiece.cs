    ...
    public partial class LegacyMainCirclePiece : CompositeDrawable
    {
        ...
        private void load()
        {
            ...
            InternalChildren = new[]
            {
                ...
                OverlayLayer = new StableLifetimeContainer
                {
                    Anchor = Anchor.Centre,
                    Origin = Anchor.Centre,
        ...
        private void updateStateTransforms(DrawableHitObject drawableHitObject, ArmedState state)
        {
            ...
            using (BeginAbsoluteSequence(drawableObject.AsNonNull().HitStateUpdateTime))
            {
                ...
                {
                    case ArmedState.Hit:
                        if (SkinPerformanceMode.Enabled && drawableHitObject is DrawableSliderHead or DrawableSliderTail or DrawableSliderRepeat)
                        {
