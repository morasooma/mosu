...
namespace osu.Game.Rulesets.Osu.Scoring
{
    public class OsuScoreMultiplierCalculatorV2 : ScoreMultiplierCalculator
    {
            ...
            : base(context)
        {
            ...
            Single<OsuModMosuStaticBpm>(hasMultiplier: staticBpm => staticBpm.SpeedChange.Value >= 1 ? doubleTimeMultiplier(staticBpm.SpeedChange.Value) : halfTimeMultiplier(staticBpm.SpeedChange.Value));
            Single<OsuModMosuTargetDifficulty>(hasMultiplier: targetDifficulty => targetDifficulty.SpeedChange.Value >= 1 ? doubleTimeMultiplier(targetDifficulty.SpeedChange.Value) : halfTimeMultiplier(targetDifficulty.SpeedChange.Value));
            
            Single<OsuModMosuAimAssist>(hasMultiplier: 0.8);
            Single<OsuModMosuRelax>(hasMultiplier: 0.1);
