...
namespace osu.Game.Rulesets.Osu.UI.Cursor
{
    public partial class OsuCursor : SkinReloadableDrawable
    {
        ...
        {
            Parent?.GetType().GetMethod("ResetTrail")?.Invoke(Parent, null);
        }
        ...
        public static float GetScaleForCircleSize(float circleSize) =>
            LegacyRulesetExtensions.SanitizeScale(1f - 0.7f * (1f + circleSize - BeatmapDifficulty.DEFAULT_DIFFICULTY) / BeatmapDifficulty.DEFAULT_DIFFICULTY);
