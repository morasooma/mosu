...
namespace osu.Game.Rulesets.Osu.Difficulty.Preprocessing
{
    public class OsuDifficultyHitObject : DifficultyHitObject
    {
        ...
        /// </summary>
        public double SmallCircleBonus => Math.Max(1.0, 1.0 + (30 - SignedRadius) / 70);

        /// <summary>
        /// Signed object radius used by difficulty calculations to preserve the fork's
        /// handling of extreme circle sizes without allowing zero-related failures.
        /// </summary>
        public double SignedRadius => getSignedRadius(BaseObject);
        ...
        private void setDistances(double clockRate)
        {
            ...
            float scalingFactor = NORMALISED_RADIUS / (float)SignedRadius;
        ...
        private void computeSliderCursorPosition()
        {
            ...
            double scalingFactor = NORMALISED_RADIUS / getSignedRadius(slider); // lazySliderDistance is coded to be sensitive to scaling, this makes the maths easier with the thresholds being used.
        ...
        private static double getSignedRadius(OsuHitObject hitObject)
        {
            return OsuHitObject.OBJECT_RADIUS * LegacyRulesetExtensions.SanitizeSignedScale(hitObject.Scale);
        }
    }
}
