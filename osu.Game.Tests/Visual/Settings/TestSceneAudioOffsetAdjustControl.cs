...
namespace osu.Game.Tests.Visual.Settings
{
    public partial class TestSceneAudioOffsetAdjustControl : OsuTestScene
    {
        ...
        [Test]
        public void TestDodgeScoresIgnored()
        {
            AddStep("set Dodge score", () => statics.SetValue(Static.LastLocalUserScore, new ScoreInfo
            {
                Ruleset = new RulesetInfo(RulesetInfo.DODGE_MODE_SHORTNAME, "Dodge", string.Empty, 10),
                HitEvents = TestSceneHitEventTimingDistributionGraph.CreateDistributedHitEvents(40),
                BeatmapInfo = Beatmap.Value.BeatmapInfo,
            }));

            AddAssert("no suggested offset", () => adjustControl.SuggestedOffset.Value, () => Is.Null);
            checkButtonDisabled();
        }
