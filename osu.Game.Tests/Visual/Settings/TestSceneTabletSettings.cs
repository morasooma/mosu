...
namespace osu.Game.Tests.Visual.Settings
{
    ...
    public partial class TestSceneTabletSettings : OsuTestScene
    {
        ...
        public class TestTabletHandler : InputHandler, ITabletHandler
        {
            ...
            public BindableFloat ReconstructorWeight { get; } = new BindableFloat
            {
                MinValue = 0.01f,
                MaxValue = 1f,
                Precision = 0.01f,
            ...
            public BindableFloat ChatterExterminationStrength { get; } = new BindableFloat(2.0f)
            {
                MinValue = 0.01f,
                MaxValue = 25.0f,
                Precision = 0.1f,
            ...
            public BindableFloat RadialFollowOuterRadius { get; } = new BindableFloat(5.0f)
            {
                MinValue = 0.0f,
                MaxValue = 100.0f,
                Precision = 0.1f,
            ...
            public BindableFloat RadialFollowInnerRadius { get; } = new BindableFloat(0.0f)
            {
                MinValue = 0.0f,
                MaxValue = 100.0f,
                Precision = 0.1f,
            ...
            public BindableFloat RadialFollowSoftKneeScale { get; } = new BindableFloat(1.0f)
            {
                MinValue = 0.0f,
                MaxValue = 100.0f,
                Precision = 0.1f,
            ...
            public BindableFloat RadialFollowSmoothingLeakCoefficient { get; } = new BindableFloat(0.0f)
            {
                MinValue = 0.0f,
                MaxValue = 1.0f,
                Precision = 0.01f,
