...
namespace osu.Game.Tests.Visual.Online
{
    public partial class TestSceneRankingsTables : OsuTestScene
    {
        ...
        private void createWeeklyPerformanceTable()
        {
            onLoadStarted();

            loadTable(new PerformanceTable(1, new List<UserStatistics>
            {
                new WeeklyRankingEntry
                {
                    User = new APIUser { Username = "rank improved", CountryCode = CountryCode.JP, Active = true },
                    GlobalRank = 3,
                    PP = 23_934,
                    RankChange = new WeeklyRankChange { Status = WeeklyRankChangeStatus.Up, Delta = 12, PreviousRank = 15 },
                },
                new WeeklyRankingEntry
                {
                    User = new APIUser { Username = "rank dropped", CountryCode = CountryCode.AU, Active = true },
                    GlobalRank = 25,
                    PP = 20_934,
                    RankChange = new WeeklyRankChange { Status = WeeklyRankChangeStatus.Down, Delta = -4, PreviousRank = 21 },
                },
                new WeeklyRankingEntry
                {
                    User = new APIUser { Username = "rank unchanged", CountryCode = CountryCode.PL, Active = true },
                    GlobalRank = 30,
                    PP = 19_568,
                    RankChange = new WeeklyRankChange { Status = WeeklyRankChangeStatus.Same, PreviousRank = 30 },
                },
                new WeeklyRankingEntry
                {
                    User = new APIUser { Username = "newly ranked", CountryCode = CountryCode.RU, Active = true },
                    GlobalRank = 58,
                    PP = 15_000,
                    RankChange = new WeeklyRankChange { Status = WeeklyRankChangeStatus.New },
                },
                new WeeklyRankingEntry
                {
                    User = new APIUser { Username = "history unavailable", CountryCode = CountryCode.US, Active = true },
                    GlobalRank = 100,
                    PP = 12_000,
                    RankChange = new WeeklyRankChange { Status = WeeklyRankChangeStatus.Unavailable },
                },
            }));
        }
