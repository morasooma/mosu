...
namespace osu.Game.Tests.Visual.Online
{
    public partial class TestSceneRankingsOverlay : OsuTestScene
    {
        ...
        [Test]
        public void TestTemporaryNullRulesetWhileModsChangeDoesNotCrash()
        {
            AddStep("set valid ruleset", () => rankingsOverlay.Header.Ruleset.Value = new OsuRuleset().RulesetInfo);
            AddStep("temporarily clear ruleset", () => rankingsOverlay.Header.Ruleset.Value = null);
            AddStep("change mods while ruleset is null", () => SelectedMods.Value = new[] { new OsuModRelax() });
            AddStep("restore ruleset", () => rankingsOverlay.Header.Ruleset.Value = new OsuRuleset().RulesetInfo);
            AddAssert("overlay recovered", () => rankingsOverlay.Header.Ruleset.Value?.ShortName == OsuRuleset.SHORT_NAME);
        }
