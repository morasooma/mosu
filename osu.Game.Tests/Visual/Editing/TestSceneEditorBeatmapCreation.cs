...
namespace osu.Game.Tests.Visual.Editing
{
    public partial class TestSceneEditorBeatmapCreation : EditorTestScene
    {
        ...
        [Test]
        public void TestCreatingFirstDodgeDifficultyOffersSeparateSet()
        {
            var dodgeRuleset = new RulesetInfo
            {
                OnlineID = 10,
                ShortName = "dodge",
                Name = "Dodge",
            ...
            AddStep("save beatmap", () => Editor.Save());
            AddStep("create first Dodge difficulty", () => Editor.CreateNewDifficulty(dodgeRuleset));
            AddUntilStep("separate set dialog shown", () => DialogOverlay.CurrentDialog is CreateSeparateRulesetBeatmapSetDialog);
        }
