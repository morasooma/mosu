...
namespace osu.Game.Tests.Visual.Navigation
{
    public partial class TestSceneEditDefaultSkin : OsuGameTestScene
    {
        ...
        public void TestEditDefaultSkin()
        {
            ...
            AddUntilStep("edit skin.ini button disabled", () => Game.Settings.ChildrenOfType<SkinSection.EditSkinIniButton>().SingleOrDefault()?.Enabled.Value == false);
            ...
            AddUntilStep("edit skin.ini button enabled", () => Game.Settings.ChildrenOfType<SkinSection.EditSkinIniButton>().SingleOrDefault()?.Enabled.Value == true);
        }
    }
}
