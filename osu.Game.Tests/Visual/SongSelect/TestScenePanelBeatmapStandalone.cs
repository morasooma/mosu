...
namespace osu.Game.Tests.Visual.SongSelect
{
    public partial class TestScenePanelBeatmapStandalone : ThemeComparisonTestScene
    {
        ...
        [Test]
        public void TestOldPreviewOffsetsContent()
        {
            AddStep("enable old previews", () => config.SetValue(OsuSetting.ForkSongSelectOldCarouselPreviews, true));
            AddStep("display", () => CreateThemedContent(OverlayColourScheme.Aquamarine));
            AddUntilStep("content clears old preview", () => this.ChildrenOfType<PanelBeatmapStandalone>().Any() && this.ChildrenOfType<PanelBeatmapStandalone>().All(panel => panel.ContentClearsLegacyPreview));
