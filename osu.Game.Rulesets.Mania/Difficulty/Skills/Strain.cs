...
namespace osu.Game.Rulesets.Mania.Difficulty.Skills
{
    public class Strain : StrainDecaySkill
    {
        ...
        private readonly double vibroPenaltyStrength;

        public Strain(Mod[] mods, int totalColumns, double vibroPenaltyStrength)
            : base(mods)
        {
            individualStrains = new double[totalColumns];
            overallStrain = 1;
            this.vibroPenaltyStrength = vibroPenaltyStrength;
        }

        protected override double StrainValueOf(DifficultyHitObject current)
        {
            var maniaCurrent = (ManiaDifficultyHitObject)current;
            double vibroPenalty = 1 - (1 - maniaCurrent.VibroPenalty) * vibroPenaltyStrength;
            ...
            individualStrains[maniaCurrent.Column] += IndividualStrainEvaluator.EvaluateDifficultyOf(current) * vibroPenalty;
            ...
            overallStrain += OverallStrainEvaluator.EvaluateDifficultyOf(current) * vibroPenalty;
