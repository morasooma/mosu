...
namespace osu.Game.Rulesets.Mania.Difficulty.Evaluators
{
    public static class OverallStrainEvaluator
    {
        ...
        public static double EvaluateDifficultyOf(DifficultyHitObject current)
        {
            ...
            // Do not award overlap/release bonuses to sustained rapid LN packs. Without this,
            // converting every vibro note to a hold can increase SR despite simplifying play.
            if (maniaCurrent.VibroPenalty < 1)
                return 1.0;
